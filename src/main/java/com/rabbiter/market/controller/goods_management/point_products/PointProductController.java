...
public class PointProductController {
    ...
    public JsonResult savePointGoods(@RequestBody PointProducts pointProducts, HttpServletRequest request) {
    ...
    public JsonResult updatePointGoods(@RequestBody PointProducts pointProducts, HttpServletRequest request) {
